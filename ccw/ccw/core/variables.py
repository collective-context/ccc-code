...
class CCWVar():
    ...
    if ccw_distro == 'ubuntu':
        ccw_nginx_repo = "ppa:ccc-code/nginx-ccw"
        ...
        ccw_nginx_repo = ("deb [signed-by=/usr/share/keyrings/ccc-code-archive-keyring.gpg] "
                         "http://download.opensuse.org"
                         f"/repositories/home:/virtubox:/CCC-CODE/{ccw_deb_repo}/ /")
        ccw_nginx_key = (f"https://download.opensuse.org/repositories/home:virtubox:CCC-CODE/{ccw_deb_repo}/Release.key")
