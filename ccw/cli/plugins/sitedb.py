...
from ccc.cli.plugins.models import SiteDB
from ccc.core.database import db_session
...
def addNewSite(self, site, stype, cache, path,
    ...
    """
    Add New Site record information into the ccc database.
    """
    try:
...
def getSiteInfo(self, site):
    """
        Retrieves site record from ccc database
    """
    try:
...
def getAllsites(self):
    """
        1. returns all records from ccc database
    """
    try:
        q = SiteDB.query.all()
        return q
